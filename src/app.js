/**
 *
 * This module contains a class that build the assignement task.
 * The builder class exposes a public property 'App' that is the built application, e.g. the EBApp.
 * The module built application is of type 'Koa'. It embeds an HTTP server that must be use to start the application.
...
/**
 * API Server Application Builder
 *
 * That class build and exposes the API Server Application object, that is of type 'Koa'.
 */
class AppBuilder {
    /**
     * The object of type 'Koa' that implements the  API Server Application.
     */
    constructor() {
        const app = new Koa()
